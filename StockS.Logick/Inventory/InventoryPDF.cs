    ...
    public class InventoryPDF
    {
        ...
        void ComposeHeader(IContainer container)
        {
            ...
            container.Row(row =>
            {
                ...
                {
                    column.Item().Text("Inventura").Style(titleStyle);
        ...
        void ComposeTable(IContainer container)
        {
            container.Table(table =>
            {
                ...
                table.Header(header =>
                {
                    ...
                    header.Cell().Element(CellStyle).Text("Artikl");
                ...
                foreach (QuantityHistory item in items)
                {
                    ...
                    table.Cell().Element(CellStyle).Text(repository.GetItemName(item.IdItem));
